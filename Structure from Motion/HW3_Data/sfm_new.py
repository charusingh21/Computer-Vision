...
class SFMSolver(object):
    ...
    def detect_and_match_feature(self, img1, img2):
        ...
        detector2 = sift.detect(gray1, None)

        kp2, des2 = sift.compute(gray1, detector1)
        print('half..')
        # FLANN parameters
...
def main():
    ...
    img_pattern = '/Users/chinmayees/Desktop/acv/HW/HW3_Data/cs677_hw3_data/rdimage.*.ppm'
    intrinsic = intrinsic_reader('/Users/chinmayees/Desktop/acv/HW/HW3_Data/cs677_hw3_data/intrinsics.txt')
    output_dir = '/Users/chinmayees/Desktop/acv/HW/HW3_Data/cs677_hw3_data/output'
