...
class SFMSolver(object):
    ...
    def detect_and_match_feature(self, img1, img2):
        ...
        print('detect_and_match_feature')
        """
        ...
        detector1 = sift.detect(gray1, None)

        kp1, des1 = sift.compute(gray1, detector1)

        detector2 = sift.detect(gray2, None)

        kp2, des2 = sift.compute(gray2, detector2)
        print('half..')
        # print('keypoint kp1',kp1)
        # print('keypoint kp2',kp2)
        # print('descriptor1',des1)
        # print('descriptor2',des2)
        print('length of descriptor1',len(des1))
        print('length of descriptor2',len(des2))
        # FLANN parameters
        ...
        #cv2.imshow('Top 20 matches between ', img3)
        ...
        # p2 = [kp1[m.trainIdx].pt for m in good ]
        print('good matches',matches_good)
        print('length of gm',len(matches_good))

        img4 = cv2.drawMatchesKnn(img1,kp1,img2,kp2,matches,None,**draw_params)

        #plt.imshow(img4,),plt.show()

        return np.float32(p1), np.float32(p2), matches_good, kp1, kp2
    ...
    def compute_essential(self, p1, p2):
        ...
        E, mask = cv2.findEssentialMat(kpts2, kpts1, self.K,
    ...
    def compute_pose(self, p1, p2, E):
       ...
       # print('compute pose: points',points)
        print('compute pose: R',R)
        print('compute pose: trans',trans)
       # print('compute pose: mask',mask)
    ...
    def triangulate(self, p1, p2, R, t, mask):
        ...
        # ...
        K = self.K
        img1ptsHom = cv2.convertPointsToHomogeneous(p1)[:,0,:]
        img2ptsHom = cv2.convertPointsToHomogeneous(p2)[:,0,:]
    ...
    def run(self):
        ...
        self.load_images()
        #self.load_images()
        #cv2.imwrite(join(self.output_dir, 'first image'), self.imgs[0])
...
def main():
    ...
    img_pattern = 'C:/Users/charu/Desktop/cv/HW3/HW3_Data/cs677_hw3_data/rdimage.*.ppm'
    intrinsic = intrinsic_reader('C:/Users/charu/Desktop/cv/HW3/HW3_Data/cs677_hw3_data/intrinsics.txt')
    output_dir = 'C:/Users/charu/Desktop/cv/HW3/HW3_Data/cs677_hw3_data/output'
